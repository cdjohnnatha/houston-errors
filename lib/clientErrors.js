...
const { Logger, DefaultError } = require('./httpRequestErrorsCore');
...
async function BadRequest(message, data) {
  return DefaultError(BAD_REQUEST, message, data);
}
...
function Unauthorized(message, data) {
  return DefaultError(UNAUTHORIZED, message, data);
}
...
function PaymentRequired(message, data) {
  return DefaultError(PAYMENT_REQUIRED, message, data);
}
...
function Forbidden(message, data) {
  ...
  return DefaultError(FORBIDDEN, message, data);
}
...
function NotFound(message, data) {
  ...
  return DefaultError(NOT_FOUND, message, data);
}
...
function MethodNotAllowed(message, data) {
  ...
  return DefaultError(METHOD_NOT_ALLOWED, message, data);
}
...
function NotAcceptable(message, data) {
  ...
  return DefaultError(NOT_ACCEPTABLE, message, data);
}
...
function ProxyAuthenticationRequired(message, data) {
  return DefaultError(PROXY_AUTHENTICATION_REQUIRED, message, data);
}
...
function RequestTimeout(message, data) {
  return DefaultError(REQUEST_TIMEOUT, message, data);
}
...
function Conflict(message, data) {
  ...
  return DefaultError(CONFLICT, message, data);
}
...
function Gone(message, data) {
  return DefaultError(GONE, message, data);
}
...
function LengthRequired(message, data) {
  return DefaultError(LENGTH_REQUIRED, message, data);
}
...
function PreconditionFailed(message, data) {
  return DefaultError(PRECONDITION_FAILED, message, data);
}
...
function PayloadTooLarge(message, data) {
  return DefaultError(PAYLOAD_TOO_LARGE, message, data);
}
...
function UriTooLong(message, data) {
  return DefaultError(URI_TOO_LONG, message, data);
}
...
function UnsupportedMediaType(message, data) {
  return DefaultError(UNSUPPORTED_MEDIA_TYPE, message, data);
}
...
function RangeNotSatisfiable(message, data) {
  return DefaultError(RANGE_NOT_SATISFIABLE, message, data);
}
...
function ExpectationFailed(message, data) {
  return DefaultError(EXPECTATION_FAILED, message, data);
}
...
function ImATeapot(message, data) {
  return DefaultError(IM_A_TEAPOT, message, data);
}
...
function MisdirectedRequest(message, data) {
  return DefaultError(MISDIRECTED_REQUEST, message, data);
}
...
function UnprocessableEntity(message, data) {
  return DefaultError(UNPROCESSABLE_ENTITY, message, data);
}
...
function Locked(message, data) {
  return DefaultError(LOCKED, message, data);
}
...
function FailedDependency(message, data) {
  return DefaultError(FAILED_DEPENDENCY, message, data);
}
...
function UnorderedCollection(message, data) {
  return DefaultError(UNORDERED_COLLECTION, message, data);
}
...
function UpgradeRequired(message, data) {
  return DefaultError(UPGRADE_REQUIRED, message, data);
}
...
function PreconditionRequired(message, data) {
  return DefaultError(PRECONDITION_REQUIRED, message, data);
}
...
function TooManyRequests(message, data) {
  return DefaultError(TOO_MANY_REQUESTS, message, data);
}
...
function RequestHeaderFieldsTooLarge(message, data) {
  return DefaultError(REQUEST_HEADER_FIELDS_TOO_LARGE, message, data);
}
...
function UnavailableForLegalReasons(message, data) {
  return DefaultError(UNAVAILABLE_FOR_LEGAL_REASONS, message, data);
}
