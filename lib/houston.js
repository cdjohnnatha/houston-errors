...
const logger = require('node-color-log');
  ...
  function DataValidation(value) {
    if (typeof value !== 'string' && typeof value !== 'object' && Array.isArray(value) === false) {
  ...
  function CleaningData(data) {
    ...
    Object.entries(cleanedData).forEach((value) => {
      ...
      if(param === undefined || param === null || param === '') {
        logger.warn(`The key ${key} is being ignored because have an undefined, empty or null value`);
