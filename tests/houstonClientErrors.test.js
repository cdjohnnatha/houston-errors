...
test('Test Bad Request', async () => {
  try {
    ...
    const defaultBadRequestError = clientErrors.BadRequest();
    ...
    const badRequestWithMessage =  clientErrors.BadRequest({message: message});
    console.log(badRequestWithMessage);
    expect(defaultBadRequestError).toHaveProperty('code', 400);
    expect(defaultBadRequestError).toHaveProperty('name', 'BAD_REQUEST');
    expect(defaultBadRequestError).toHaveProperty('error', 'Bad Request');
    expect(defaultBadRequestError).not.toHaveProperty('data');
    ...
    const badRequestWithMessageData =  await clientErrors.BadRequest({message: message, data: data});
    expect(defaultBadRequestError).toHaveProperty('code', 400);
    expect(defaultBadRequestError).toHaveProperty('name', 'BAD_REQUEST');
    expect(defaultBadRequestError).toHaveProperty('error', 'Bad Request');
...
test('Test UNAUTHORIZED 401 Request', async () => {
  try {
    ...
    const UnauthorizedWithMessage =  await clientErrors.Unauthorized({ message: message });
    ...
    const UnauthorizedWithMessageData =  await clientErrors.Unauthorized({message: message, data: data});
...
test('Test PAYMENT_REQUIRED 402 Request', async () => {
  try {
    ...
    const PaymentRequiredWithMessage =  await clientErrors.PaymentRequired({ message: message });
    ...
    const PaymentRequiredWithMessageData =  await clientErrors.PaymentRequired({message: message, data: data});
...
const ForbiddenWithMessage =  await clientErrors.Forbidden({ message: message });
...
const ForbiddenWithMessageData =  await clientErrors.Forbidden({message: message, data: data});
...
test('Test NOT_FOUND 404 Request', async () => {
  ...
  const NotFoundWithMessage =  await clientErrors.NotFound({ message: message });
  ...
  const NotFoundWithMessageData =  await clientErrors.NotFound({ message: message, data: data });
...
test('Test METHOD_NOT_ALLOWED 405 Request', async () => {
  ...
  const MethodNotAllowedWithMessage =  await clientErrors.MethodNotAllowed({ message: message });
  ...
  const MethodNotAllowedWithMessageData =  await clientErrors.MethodNotAllowed({ message: message, data: data });
...
test('Test NOT_ACCEPTABLE 406 Request', async () => {
  ...
  const NotAcceptableWithMessage =  await clientErrors.NotAcceptable({ message: message });
  ...
  const NotAcceptableWithMessageData =  await clientErrors.NotAcceptable({message: message, data: data});
...
test('Test PROXY_AUTHENTICATION_REQUIRED 407 Request', async () => {
  ...
  const ProxyAuthenticationRequiredWithMessage =  await clientErrors.ProxyAuthenticationRequired({ message: message });
  ...
  const ProxyAuthenticationRequiredWithMessageData =  await clientErrors.ProxyAuthenticationRequired({message: message, data: data});
...
test('Test REQUEST_TIMEOUT 408 Request', async () => {
  ...
  const RequestTimeoutWithMessage =  await clientErrors.RequestTimeout({ message: message });
  ...
  const RequestTimeoutWithMessageData =  await clientErrors.RequestTimeout({message: message, data: data});
...
test('Test CONFLIT 409 Request', async () => {
  ...
  const ConflictWithMessage =  await clientErrors.Conflict({ message: message });
  ...
  const ConflictWithMessageData =  await clientErrors.Conflict({message: message, data: data});
...
test('Test GONE 410 Request', async () => {
  ...
  const GoneWithMessage =  await clientErrors.Gone({ message: message });
  ...
  const GoneWithMessageData =  await clientErrors.Gone({message: message, data: data});
...
test('Test LENGTH_REQUIRED 411 Request', async () => {
  ...
  const LengthRequiredWithMessage =  await clientErrors.LengthRequired({ message: message });
  ...
  const LengthRequiredWithMessageData =  await clientErrors.LengthRequired({message: message, data: data});
...
test('Test PRECONDITION_FAILED 412 Request', async () => {
  ...
  const PreconditionFailedWithMessage =  await clientErrors.PreconditionFailed({ message: message });
  ...
  const PreconditionFailedWithMessageData =  await clientErrors.PreconditionFailed({message: message, data: data});
...
test('Test PAYLOAD_TOO_LARGE 413 Request', async () => {
  ...
  const PayloadTooLargeWithMessage =  await clientErrors.PayloadTooLarge({ message: message });
  ...
  const PayloadTooLargeWithMessageData =  await clientErrors.PayloadTooLarge({message: message, data: data});
...
test('Test URI_TOO_LONG 414 Request', async () => {
  ...
  const UriTooLongWithMessage =  await clientErrors.UriTooLong({ message: message });
  ...
  const UriTooLongWithMessageData =  await clientErrors.UriTooLong({message: message, data: data});
...
test('Test UNSUPPORTED_MEDIA_TYPE 415 Request', async () => {
  ...
  const UnsupportedMediaTypeWithMessage =  await clientErrors.UnsupportedMediaType({ message: message });
  ...
  const UnsupportedMediaTypeWithMessageData =  await clientErrors.UnsupportedMediaType({message: message, data: data});
...
test('Test RANGE_NOT_SATISFIABLE 416 Request', async () => {
  ...
  const RangeNotSatisfiableWithMessage =  await clientErrors.RangeNotSatisfiable({ message: message });
  ...
  const RangeNotSatisfiableWithMessageData =  await clientErrors.RangeNotSatisfiable({message: message, data: data});
...
test('Test EXPECTATION_FAILED 417 Request', async () => {
  ...
  const ExpectationFailedWithMessage =  await clientErrors.ExpectationFailed({ message: message });
  ...
  const ExpectationFailedWithMessageData =  await clientErrors.ExpectationFailed({message: message, data: data});
...
test('Test IM_A_TEAPOT 418 Request', async () => {
  ...
  const ImATeapotWithMessage =  await clientErrors.ImATeapot({ message: message });
  ...
  const ImATeapotWithMessageData =  await clientErrors.ImATeapot({message: message, data: data});
...
test('Test UNPROCESSABLE_ENTITY 421 Request', async () => {
  ...
  const MisdirectedRequestWithMessage =  await clientErrors.MisdirectedRequest({ message: message });
  ...
  const MisdirectedRequestWithMessageData =  await clientErrors.MisdirectedRequest({message: message, data: data});
...
test('Test UNPROCESSABLE_ENTITY 422 Request', async () => {
  ...
  const UnprocessableEntityWithMessage =  await clientErrors.UnprocessableEntity({ message: message });
  ...
  const UnprocessableEntityWithMessageData =  await clientErrors.UnprocessableEntity({message: message, data: data});
...
test('Test LOCKED 423 Request', async () => {
  ...
  const LockedWithMessage =  await clientErrors.Locked({ message: message });
  ...
  const LockedWithMessageData =  await clientErrors.Locked({message: message, data: data});
...
test('Test FAILED_DEPENDENCY 424 Request', async () => {
  ...
  const FailedDependencyWithMessage =  await clientErrors.FailedDependency({ message: message });
  ...
  const FailedDependencyWithMessageData =  await clientErrors.FailedDependency({message: message, data: data});
...
test('Test UNORDERED_COLLECTION 425 Request', async () => {
  ...
  const UnorderedCollectionWithMessage =  await clientErrors.UnorderedCollection({ message: message });
  ...
  const UnorderedCollectionWithMessageData =  await clientErrors.UnorderedCollection({message: message, data: data});
...
test('Test UPGRADE_REQUIRED 426 Request', async () => {
  ...
  const UpgradeRequiredWithMessage =  await clientErrors.UpgradeRequired({ message: message });
  ...
  const UpgradeRequiredWithMessageData =  await clientErrors.UpgradeRequired({message: message, data: data});
...
test('Test PRECONDITION_REQUIRED 428 Request', async () => {
  ...
  const PreconditionRequiredWithMessage =  await clientErrors.PreconditionRequired({ message: message });
  ...
  const PreconditionRequiredWithMessageData =  await clientErrors.PreconditionRequired({message: message, data: data});
...
test('Test TOO_MANY_REQUESTS 429 Request', async () => {
  ...
  const TooManyRequestsWithMessage =  await clientErrors.TooManyRequests({ message: message });
  ...
  const TooManyRequestsWithMessageData =  await clientErrors.TooManyRequests({message: message, data: data});
...
test('Test REQUEST_HEADER_FIELDS_TOO_LARGE 431 Request', async () => {
  ...
  const RequestHeaderFieldsTooLargeWithMessage =  await clientErrors.RequestHeaderFieldsTooLarge({ message: message });
  ...
  const RequestHeaderFieldsTooLargeWithMessageData =  await clientErrors.RequestHeaderFieldsTooLarge({message: message, data: data});
...
test('Test UNAVAILABLE_FOR_LEGAL_REASONS 451 Request', async () => {
  ...
  const UnavailableForLegalReasonsWithMessage =  await clientErrors.UnavailableForLegalReasons({ message: message });
  ...
  const UnavailableForLegalReasonsWithMessageData =  await clientErrors.UnavailableForLegalReasons({message: message, data: data});
